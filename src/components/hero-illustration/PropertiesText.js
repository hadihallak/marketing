      ...
      <Flexbox fg_1 fb_0 pr_2>
        ...
        >
          <svg
            ...
            stroke="currentColor"
          >
          <path d="M10.5 17.5L7.5 20.5L4.5 17.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M10.5 7.5L7.5 4.5L4.5 7.5" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <Flexbox fg_1 fb_0 pl_2>
        ...
        >
          <svg
            ...
            stroke="currentColor"
          >
          <path d="M7.5 20.5L4.5 17.5L7.5 14.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M17.5 20.5L20.5 17.5L17.5 14.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M11.5 11.5L8.5 4.5L5.5 11.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M19.5 4.5L16.5 11.5L13.5 4.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M6.5 9.5H10.5" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <Tooltip data-tooltip="Normal" data-position="top">
          ...
          >
            <svg
              ...
              stroke="currentColor"
            >
            <path d="M15.5 7.5H9.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M15.5 17.5H9.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M12.5 7.5V17.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </ToggleButton>
        </Tooltip>
        <Tooltip data-tooltip="Italic" data-position="top">
          ...
          >
            <svg
              ...
              stroke="currentColor"
            >
            <path d="M17.5 7.5H11.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M13.5 17.5H7.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M14.5 7.5L10.5 17.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </ToggleButton>
        </Tooltip>
      </Flexbox>
        ...
        <Tooltip data-tooltip="Uppercase" data-position="top">
          ...
          >
            <svg
              ...
              stroke="currentColor"
            >
              <path d="M13.5 17.5L17 7.5L20.5 17.5" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <Flexbox fg_1 fb_0 pl_2>
        <Tooltip data-tooltip="Underline" data-position="top">
          ...
          >
            ...
            <path d="M8.49995 7.5C8.49995 13.5 7.99995 17.5 12.4999 17.5C16.9999 17.5 16.4999 13.5 16.4999 7.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </ToggleButton>
        </Tooltip>
