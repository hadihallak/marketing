    ...
    >
      ...
      <Box mr_1>
        <GhostButton size1 tabIndex="-1">
          ...
          >
          <rect x="2" y="2" width="8" height="8" rx="1" fill="#0088FF" stroke="none"/>
          <path d="M11.5 5.5H12C12.2761 5.5 12.5 5.72386 12.5 6V12C12.5 12.2761 12.2761 12.5 12 12.5H6C5.72386 12.5 5.5 12.2761 5.5 12V11.5" strokeLinecap="round"/>
          </svg>
        </GhostButton>
      </Box>
      <Box fs_0 pr_2>
    ...
    <Flexbox mt_2 ai_center jc_spacebetween style={{marginLeft: '-5px',marginRight: '-5px'}}>
      <Box mr_1>
        <GhostButton size1 tabIndex="-1">
          ...
          <path d="M11 10.5V4H12C12.5523 4 13 4.44772 13 5V12C13 12.5523 12.5523 13 12 13H5C4.44772 13 4 12.5523 4 12V11H10.5C10.7761 11 11 10.7761 11 10.5Z" fill="#0088FF" stroke="none"/>
          </svg>
        </GhostButton>
      </Box>
      <Box fs_0 pr_2>
